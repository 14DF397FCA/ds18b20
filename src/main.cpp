...
//  LCD
const int8_t lcdQuarterFirst = 32;
const int8_t lcdQuarterSecond = 64;
const int8_t lcdQuarterThird = 96;
...
const uint8_t *font = u8g2_font_7x14_tf;
const uint8_t charLengthPix = 7;
const uint8_t charHeightPix = 14;
//const uint8_t *font = u8g2_font_6x12_tf;
//const uint8_t charLengthPix = 6;
//const uint8_t charHeightPix = 12;

//  How often show sensors addresses
const uint8_t loopNum = 30;
uint8_t loopId = 0;
